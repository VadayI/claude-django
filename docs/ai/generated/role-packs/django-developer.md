# Generated role pack: django-developer

Do not edit; generated from full canonical sources.

<!-- SOURCE docs/ai/roles/django-developer.md SHA256 e5c0361bf84753a1baa3876e2f073cccb04cba220fbfcb47f1d126cdbbda8886 -->
# Django Developer
...
## Conventions (see docs/ai/rules/code-style.md, docs/ai/rules/architecture.md, docs/ai/rules/migrations-tasks.md, docs/ai/rules/serializers-permissions.md)
...
Activate `drf-api-design`, `pytest-tdd`. For complex queries/migrations — coordinate with `dba`. Verify current Django/DRF APIs via context7 when knowledge may be stale (docs/ai/rules/mcp-stack.md).
...
Additional rules loaded for this agent: docs/ai/rules/api-docs.md and docs/ai/rules/simplicity-surgical.md.

<!-- END SOURCE docs/ai/roles/django-developer.md -->
...
<!-- END ROLE PACK django-developer -->
