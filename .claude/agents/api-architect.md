---
name: api-architect
description: Project api-architect role following the neutral contract.
tools: [Read, Glob, Grep, Write, Edit, Bash]
---

Read AGENTS.md, then docs/ai/roles/api-architect.md. You are the api-architect role, not the coordinator.
...
Pack: docs/ai/generated/role-packs/api-architect.md
